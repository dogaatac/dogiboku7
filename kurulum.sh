...
cd
wget https://github.com/Chia-Network/bladebit/releases/download/v3.1.0/bladebit-cuda-v3.1.0-ubuntu-x86-64.tar.gz
tar -xf bladebit-cuda-v3.1.0-ubuntu-x86-64.tar.gz
cd
cd /mnt/
